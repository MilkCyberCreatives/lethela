...
const catalogProducts: CatalogProductRecord[] = [
  ...
  },
  {
    ...
    vendorId: "vendor-demo-braai-spot",
    vendorSlug: "demo-braai-spot",
    vendorName: "Demo Braai Spot",
  ...
  },
  {
    ...
    vendorId: "vendor-demo-breakfast-corner",
    vendorSlug: "demo-breakfast-corner",
    vendorName: "Demo Breakfast Corner",
  ...
  },
  {
    ...
    vendorId: "vendor-demo-liquor-locker",
    vendorSlug: "demo-liquor-locker",
    vendorName: "Demo Liquor Locker",
...
const sectionsBySlug: Record<string, CatalogSection[]> = {
  ...
  "demo-wings-yard": [
    {
      id: "section-demo-wings-yard-main",
  ...
  "demo-braai-spot": [
    {
      id: "section-demo-braai-spot-main",
      title: "Braai plates",
      sortOrder: 1,
      items: [
        {
  ...
  "demo-breakfast-corner": [
    {
      id: "section-demo-breakfast-corner-main",
      title: "Breakfast",
      sortOrder: 1,
      items: [
        {
  ...
  "demo-liquor-locker": [
    {
      id: "section-demo-liquor-locker-main",
      title: "Alcohol",
      sortOrder: 1,
      items: [
        {
