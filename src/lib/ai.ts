...
export async function aiSearch(q: string): Promise<AIResult> {
  ...
  const all: AIResult["results"] = [
    ...
    {
      title: "Romans Family Pizza",
      subtitle: "Romans Pizza - 30-35 min",
    ...
    {
      title: "Cape Dry Cider 6-pack",
      subtitle: "Beer and Cider - 18+",
...
export async function aiRecommend(suburb: string | null): Promise<AIResult> {
  ...
  const base: AIResult["results"] = [
    ...
    {
      title: "Romans Pizza",
      subtitle: "Pizza - 30-35 min",
      image: "/vendors/grill.jpg",
      vendor: "Romans Pizza",
      slug: "romans-pizza",
    },
    {
      title: "Bottle Co. Stellenbosch Red",
      subtitle: "Wine - 18+",
      image: "/vendors/vegan.jpg",
      vendor: "Bottle Co.",
      slug: "bottle-co",
