    ...
    <PageShell contentClassName="max-w-3xl">
      <div className="rounded-2xl border border-white/15 bg-white/5 p-6 md:p-8">
        ...
        <p className="mt-3 max-w-2xl text-sm text-white/75">
          This page is for Lethela owner access only. Use your admin sign-in or your approval key to
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          ...
          <div className="rounded-xl border border-white/10 p-4">
            ...
            <p className="mt-2 text-sm text-white/75">
              If you use an admin approval key, enter it here once to enable secure admin access in
              this browser.
            </p>
            <AdminPortalKeyForm />
          </div>
