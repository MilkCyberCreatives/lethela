  ...
  return (
    ...
    >
      <Section title="What we collect">
        <p>
          We may collect account details, names, phone numbers, email addresses, delivery locations,
          order history, vendor registration information, rider application information, device and
          usage data, support messages, and payment references needed to complete transactions.
        </p>
      </Section>

      <Section title="How we use personal information">
        <p>
          We use data to create accounts, process orders, route deliveries, provide WhatsApp
      ...
      <Section title="Who we share information with">
        <p>
          Information may be shared only where needed with approved vendors, riders, payment
      ...
      <Section title="Cookies and platform analytics">
        <p>
          We use essential cookies and local storage for login state, cart contents, saved meal
      ...
      <Section title="Your POPIA rights">
        <p>
          Subject to POPIA and other applicable law, you may request access to your information, ask
      ...
      <Section title="Direct marketing">
        <p>
          Marketing messages should only be sent where lawful and appropriate. You may opt out of
          direct marketing at any time by using the unsubscribe instruction in the message or
          contacting Lethela support.
        </p>
      </Section>
      ...
      <Section title="Privacy contact and complaints">
        ...
        <p>
          If you remain dissatisfied after contacting us, you may contact the South African
          Information Regulator. You can also review our{" "}
          <Link href="/popia" className="underline">
            POPIA notice
          </Link>{" "}
          and{" "}
          <Link href="/paia-manual" className="underline">
            PAIA access guide
          </Link>
          .
        </p>
