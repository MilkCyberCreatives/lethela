  ...
  const messages = [
    {
      role: "system",
      content:
        "You are a pricing assistant for a South African food delivery app. Return a fair, round ZAR price as an integer (e.g. 89, 119), considering value perception. Do not add currency symbols, just the number. Prefer 9-ending pricing (e.g. 89, 99, 109).",
    },
    {
      role: "user",
