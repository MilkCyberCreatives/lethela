...
export default function RecommendationsGrid({
  ...
  const visibleCards = cards.filter((card) => card.slug);
    ...
    <section className="container py-10">
      ...
      {loading ? (
        ...
        <div className="rounded-lg border border-white/15 bg-white/5 p-5 text-sm leading-6 text-white/72">
          We are still onboarding approved vendors in this area. Recommendations will appear after
          approved vendors have live products and trading hours.
        </div>
      ) : (
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
